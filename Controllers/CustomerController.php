        ...
        switch ($this->getUserAction()) {
            ...
            case "insertNewItem":
                ...
                if (isset($_POST['formValues'])) {
                    ...
                    //convert json string into array
                    //$jsonData = json_decode($_POST['formValues'][0], true);
                }
...
function testAddNewItem() {
    ...
    $jsonRaw = '{"userAction":"addNewItem", "formValues":'
            . '[{'
            . '"name":"Customer-1323"'
            . ',"lastName":"surname-1323"'
            . ',"email":"test-custom@yahoo.fr"'
            . ',"phoneNumber":"23232323"'
            . ',"zipCode":"885544"'
            . ',"city":"city-Douala"'
            . ',"street":"street-custom"'
            . ' }]
              }';
...
function testUpdateItem() {
    ...
    $jsonRaw = '{"userAction":"updateItem", "customerId":"3", "formValues":'
            . '[{'
            . '"name":"Customer-1323-new"'
            . ',"lastName":"surname-1323"'
            . ',"email":"test-custom-new@yahoo.fr"'
            . ',"phoneNumber":"23232323-new"'
            . ',"zipCode":"885544-new"'
            . ',"city":"city-Douala-new"'
            . ',"street":"street-custom-new"'
            . ' }]
              }';
...
function testDeleteItem() {
    ...
    $jsonRaw = '{"selectedIds":["4", "5", "6"], "userAction":"deleteItem"}';
...
function testInlineUpdateItem() {

    $jsonRaw = '{"customerId":"7","formValues":[{"newFieldValue":"TEST-inline","fieldName":"name","entityKeyId":"7"}]'
                .',"updateMode":"inlineUpdate","userAction":"updateItem"}';
