...
!function t(e, i, a) {
    ...
    25: [function(t, e, i) {
        ...
        e.exports = function(t) {
            ...
            o.requestAnimFrame = function() {
                ...
                a = a || {}, a.data = a.data || {}, a.garbageCollect = a.garbageCollect || [],
                    a.font !== e && (a.data = {}, a.garbageCollect = [], a.font = e), t.font = e;
                var s = 0;
                o.each(i, function(e) {
                    if (void 0 !== e && null !== e) {
                        var i = a.data[e];
    ...
    26: [function(t, e, i) {
        ...
        e.exports = function() {
            var t = function(e, i) {
                this.config = i, e.length && e[0].getContext && (e = e[0]), e.getContext && (e = e.getContext("2d")), 
                        this.ctx = e, this.canvas = e.canvas,
                        ...
                        this.aspectRatio = this.width / this.height, (isNaN(this.aspectRatio) || isFinite(this.aspectRatio) === !1) && (this.aspectRatio = void 0 !== i.aspectRatio ? i.aspectRatio : 2), this.originalCanvasStyleWidth = e.canvas.style.width, this.originalCanvasStyleHeight = e.canvas.style.height, t.helpers.retinaScale(this), i && (this.controller = new t.Controller(this));
                var a = this;
                ...
                update: function(t, i, a) {
                    ...
                    if (t) {
                        ...
                        e.each(c.concat(d), s), e.each(c, function(t) {
                            ...
                            A += t.height
                        }), e.each(c.concat(d), n), w = h, D = h, M = l, A = l, e.each(c, function(t) {
                            w += t.width
                        }), e.each(d, function(t) {
                            D += t.width
                        }), e.each(u, function(t) {
            ...
            t.defaults.global.legend = {
                ...
                fit: function() {
                    var i = this.ctx,
                        ...
                        o = e.getValueOrDefault(this.options.labels.fontStyle, t.defaults.global.defaultFontStyle),
                        s = e.getValueOrDefault(this.options.labels.fontFamily, t.defaults.global.defaultFontFamily),
                    ...
                    if (this.legendHitBoxes = [], this.isHorizontal() ? this.minSize.width = this.maxWidth : this.minSize.width = this.options.display ? 10 : 0, this.isHorizontal() ? this.minSize.height = this.options.display ? 10 : 0 : this.minSize.height = this.maxHeight, this.options.display && this.isHorizontal()) {
                        ...
                        i.textAlign = "left", i.textBaseline = "top", i.font = n, e.each(this.legendItems, function(t, e) {
                            var o = this.options.labels.boxWidth + a / 2 + i.measureText(t.text).width;
                            this.lineWidths[this.lineWidths.length - 1] + o + this.options.labels.padding >= this.width && (r += a + this.options.labels.padding, this.lineWidths[this.lineWidths.length] = this.left), this.legendHitBoxes[e] = {
                                left: 0,
                                top: 0,
                                width: o,
                                height: a
                ...
                draw: function() {
                    if (this.options.display) {
                        var i = this.ctx,
                            ...
                            o = e.getValueOrDefault(this.options.labels.fontColor, t.defaults.global.defaultFontColor),
                ...
                handleEvent: function(t) {
                    ...
                    if (i.x >= this.left && i.x <= this.right && i.y >= this.top && i.y <= this.bottom)
                        for (var a = 0; a < this.legendHitBoxes.length; ++a) {
                            ...
                            if (i.x >= o.left && i.x <= o.left + o.width && i.y >= o.top && i.y <= o.top + o.height) {
    ...
    29: [function(t, e, i) {
        ...
        e.exports = function(t) {
            ...
            t.plugins = [], t.pluginService = {
                ...
                remove: function(e) {
                    var i = t.plugins.indexOf(e); - 1 !== i && t.plugins.splice(i, 1)
                },
            ...
            t.defaults.scale = {
                ...
                fit: function() {
                    ...
                    if (this.isHorizontal() ? this.minSize.width = this.isFullWidth() ? this.maxWidth - this.margins.left - this.margins.right : this.maxWidth : this.minSize.width = this.options.gridLines.tickMarkLength, this.isHorizontal() ? this.minSize.height = this.options.gridLines.tickMarkLength : this.minSize.height = this.maxHeight, this.options.scaleLabel.display && (this.isHorizontal() ? this.minSize.height += 1.5 * n : this.minSize.width += 1.5 * n), this.options.ticks.display && this.options.display) {
                        ...
                        var l = e.longestText(this.ctx, s, this.ticks, this.longestTextCache);
                        if (this.isHorizontal()) {
                            this.longestLabelWidth = l;
                            var c = Math.sin(e.toRadians(this.labelRotation)) * this.longestLabelWidth + 1.5 * i;
                            this.minSize.height = Math.min(this.maxHeight, this.minSize.height + c), this.ctx.font = s;
                            ...
                            this.options.ticks.mirror || (l += this.options.ticks.padding), p > l ? this.minSize.width += l : this.minSize.width = this.maxWidth, this.paddingTop = i / 2, this.paddingBottom = i / 2
                        }
                    }
                    ...
                    if (this.options.display) {
                        ...
                        if (this.ctx.fillStyle = c, this.isHorizontal()) {
                            ...
                            if (e.each(this.ticks, function(t, o) {
                                ...
                                var A = "left" === this.options.position ? -.5 * Math.PI : .5 * Math.PI;
                                this.ctx.save(), this.ctx.translate(s, n), this.ctx.rotate(A), this.ctx.textAlign = "center", this.ctx.fillStyle = m, this.ctx.font = y, this.ctx.textBaseline = "middle", this.ctx.fillText(this.options.scaleLabel.labelString, 0, 0), this.ctx.restore()
                            }
                        }
                        ...
                        var _ = this.left,
                            ...
                            F = this.top,
                            P = this.bottom;
                        this.isHorizontal() ? (F = P = "top" === this.options.position ? this.bottom : this.top, F += e.aliasPixel(this.ctx.lineWidth), P += e.aliasPixel(this.ctx.lineWidth)) : (_ = I = "left" === this.options.position ? this.right : this.left, _ += e.aliasPixel(this.ctx.lineWidth), I += e.aliasPixel(this.ctx.lineWidth)), this.ctx.beginPath(), this.ctx.moveTo(_, F), this.ctx.lineTo(I, P), this.ctx.stroke()
                    }
                }
            })
        }
            ...
            t.defaults.global.title = {
                ...
                fit: function() {
                    var i = (this.ctx, e.getValueOrDefault(this.options.fontSize, t.defaults.global.defaultFontSize)),
                        ...
                        o = e.getValueOrDefault(this.options.fontFamily, t.defaults.global.defaultFontFamily);
                    e.fontString(i, a, o);
                ...
                draw: function() {
                    if (this.options.display) {
                        var i, a, o = this.ctx,
                            s = e.getValueOrDefault(this.options.fontColor, t.defaults.global.defaultFontColor),
                        ...
                        if (o.fillStyle = s, o.font = l, this.isHorizontal()) o.textAlign = "center", o.textBaseline = "middle", i = this.left + (this.right - this.left) / 2, a = this.top + (this.bottom - this.top) / 2, o.fillText(this.options.text, i, a);
                        else {
                            ...
                            o.save(), o.translate(i, a), o.rotate(c), o.textAlign = "center", o.textBaseline = "middle", o.fillText(this.options.text, 0, 0), o.restore()
                        }
                    }
                }
            })
                ...
                inRange: function(t, e) {
                    ...
                    if (a) {
                        for (var o = i.getAngleFromPoint(a, {
                                x: t,
                                y: e
                            }), s = a.startAngle, n = a.endAngle; s > n;) n += 2 * Math.PI;
                        for (; o.angle > n;) o.angle -= 2 * Math.PI;
                        for (; o.angle < s;) o.angle += 2 * Math.PI;
                        var r = o.angle >= s && o.angle <= n,
                            h = o.distance >= a.innerRadius && o.distance <= a.outerRadius;
                        return r && h
                    }
                    return !1
                },
