...
require({
    cache: {
        ...
        "dojo/i18n": function () {
            define(["./_base/kernel", "require", "./has", "./_base/array", "./_base/config", "./_base/lang", "./_base/xhr", "./json", "module"], function (dojo, _202, has, _203, _204, lang, xhr, json, _205) {
                    ...
                    load = function (id, _225, load) {
                        if (has("dojo-preload-i18n-Api")) {
                            ...
                            if (_227) {
                                if (!_20f[id]) {
                                    _20f[id] = 1;
                                    _228(_226[2], json.parse(_226[3]), 1, _225);
                                }
                                load(1);
                            }
                            if (_227 || _229(id, _225, load)) {
                                return;
                            }
                        }
                        var _22a = _207.exec(id),
                            _22b = _22a[1] + "/",
                            _22c = _22a[5] || _22a[4],
                            _22d = _22b + _22c,
                            _22e = (_22a[5] && _22a[4]),
                            _22f = _22e || dojo.locale || "",
                            _230 = _22d + "/" + _22f,
                            _231 = _22e ? [_22f] : _223(_22f),
                            _232 = _231.length,
                            _233 = function () {
                                if (!--_232) {
                                    load(lang.delegate(_20f[_230]));
                                }
                            };
                        _203.forEach(_231, function (_234) {
                            var _235 = _22d + "/" + _234;
                            if (has("dojo-preload-i18n-Api")) {
                                _236(_235);
                            }
                            if (!_20f[_235]) {
                                _218(_225, _22d, _22b, _22c, _234, _233);
                            } else {
                                _233();
                            }
                        });
                ...
                if (has("dojo-preload-i18n-Api") || 1) {
                    var _237 = _206.normalizeLocale = function (_238) {
                        var _239 = _238 ? _238.toLowerCase() : dojo.locale;
                        return _239 == "root" ? "ROOT" : _239;
                    },
                        isXd = function (mid, _23a) {
                            return (1 && 1) ? _23a.isXdUrl(_202.toUrl(mid + ".js")) : true;
                        },
                        _23b = 0,
                        _23c = [],
                        _228 = _206._preloadLocalizations = function (_23d, _23e, _23f, _240) {
                            _240 = _240 || _202;

                            function _241(mid, _242) {
                                if (isXd(mid, _240) || _23f) {
                                    _240([mid], _242);
                                } else {
                                    _25c([mid], _242, _240);
                                }
                            ...
                            function _247() {
                                --_23b;
                                while (!_23b && _23c.length) {
                                    load.apply(null, _23c.shift());
                                }
                            };

                            function _248(path, name, loc, _249) {
                                return _249.toAbsMid(path + name + "/" + loc);
                            };

                            function _24a(_24b) {
                                _24b = _237(_24b);
                                _243(_24b, function (loc) {
                                    if (_203.indexOf(_23e, loc) >= 0) {
                                        var mid = _23d.replace(/\./g, "/") + "_" + loc;
                                        _246();
                                        _241(mid, function (_24c) {
                                            for (var p in _24c) {
                                                var _24d = _24c[p],
                                                    _24e = p.match(/(.+)\/([^\/]+)$/),
                                                    _24f, _250;
                                                ...
                                                var _251;
                                                if (loc === "ROOT") {
                                                    var root = _251 = _24d._localized;
                                                    delete _24d._localized;
                                                    root.root = _24d;
                                                    _20f[_202.toAbsMid(p)] = root;
                                                } else {
                                                    _251 = _24d._localized;
                                                    _20f[_248(_250, _24f, loc, _202)] = _24d;
                                                }
                                                if (loc !== _24b) {
                                                    function _252(_253, _254, _255, _256) {
                                                        ...
                                                        _243(_24b, function (loc) {
                                                            if (_256[loc]) {
                                                                _257.push(_202.toAbsMid(_253 + loc + "/" + _254));
                                                                _258.push(_248(_253, _254, loc, _202));
                                                            }
                                                        });
                                                        if (_257.length) {
                                                            _246();
                                                            _240(_257, function () {
                                                                for (var i = _257.length - 1; i >= 0; i--) {
                                                                    _255 = lang.mixin(lang.clone(_255), arguments[i]);
                                                                    _20f[_258[i]] = _255;
                                                                }
                                                                _20f[_248(_253, _254, _24b, _202)] = lang.clone(_255);
                                                                _247();
                                                            });
                                                        } else {
                                                            _20f[_248(_253, _254, _24b, _202)] = _255;
                                                        }
                                                    };
                                                    _252(_250, _24f, _24d, _251);
                                                }
                                            }
                                            _247();
                                        });
                            ...
                            _24a();
                            _203.forEach(dojo.config.extraLocale, _24a);
                        },
                        _229 = function (id, _259, load) {
                            if (_23b) {
                                _23c.push([id, _259, load]);
                            }
                            return _23b;
                        },
                        _236 = function () { };
                ...
                if (1) {
                    var _25a = {},
                        ...
                        _25c = function (deps, _25d, _25e) {
                            var _25f = [];
                            _203.forEach(deps, function (mid) {
                                var url = _25e.toUrl(mid + ".js");

                                function load(text) {
                                    var _260 = _25b(text, _236, mid, _25a);
                                    if (_260 === _25a) {
                                ...
                                if (_20f[url]) {
                                    ...
                                    if (!_261) {
                                        _261 = _236(mid.replace(/nls\/([^\/]*)\/([^\/]*)$/, "nls/$2/$1"));
                                    }
                                    if (_261) {
                                        _25f.push(_261);
                                    } else {
        ...
        "dojo/request/util": function () {
            define(["exports", "../errors/RequestError", "../errors/CancelError", "../Deferred", "../io-query", "../_base/array", "../_base/lang", "../promise/Promise"], function (_3d7, _3d8, _3d9, _3da, _3db, _3dc, lang, _3dd) {
